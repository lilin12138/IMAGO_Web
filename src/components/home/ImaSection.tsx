...
export default function ImaSection() {
  const t = useTranslations('ima');
  ...
  return (
    <section id="ima" className="snap-section w-full min-h-screen flex flex-col items-center justify-center py-10 md:py-20 bg-[#232323]">
        ...
        <div className="section-title text-center">
          <div className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-4">
            ...
            <div className="flex items-center">
              <span className="text-[#e67e22] text-4xl md:text-5xl font-bold">MA</span>
              <span className="text-[#e67e22] text-2xl md:text-3xl font-normal ml-2">({t('annotation')})</span>
            </div>
            {/* 手机版第二行 / 电脑版右侧：观点社区 */}
