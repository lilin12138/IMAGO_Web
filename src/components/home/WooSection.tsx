...
export default function WooSection() {
  const t = useTranslations('woo');
  ...
  return (
    <section id="woo" className="snap-section w-full min-h-screen flex flex-col items-center justify-center py-10 md:py-20 bg-[#232323]">
        ...
        <div className="section-title text-center">
          <div className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-4">
            ...
            <div className="flex items-center">
              <span className="text-[var(--woo-pink)] text-4xl md:text-5xl font-bold">I</span>
              <span className="text-[var(--woo-pink)] text-2xl md:text-3xl font-normal ml-2">({t('annotation')})</span>
            </div>
            {/* 手机版第二行 / 电脑版右侧：创造分享 */}
          ...
          <div className="content-slide-right flex flex-col items-center lg:items-start lg:w-[480px]">
            ...
            <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-center">
              ...
              <div className="text-[#808080] text-base md:text-lg leading-loose text-center md:text-left">
                <p className="md:hidden">{t('desc1')}{t('desc2')}</p>
